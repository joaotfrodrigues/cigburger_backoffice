<div class="col">
    <div class="row content-box">
        ...
        <div class="col-12 text-end">
            <a href="#" class="btn btn-sm btn-outline-success px-3 m-1"><i class="fa-regular fa-square-plus me-3"></i>Adicionar Stock</a>
            <a href="#" class="btn btn-sm btn-outline-danger px-3 m-1"><i class="fa-regular fa-square-minus me-3"></i>Eliminar Stock</a>
