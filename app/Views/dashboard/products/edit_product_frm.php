    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-12 p-5">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="text_name" id="text_name" class="form-control" placeholder="Nome do produto" value="<?= $product->name ?>">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="text_description" id="text_description" class="form-control" placeholder="Descrição do produto" value="<?= $product->description ?>">
            ...
            <div class="row">
                <div class="col-lg-6 col-12">
                    <div class="mb-3">
                        ...
                        <input list="list_categories" name="text_category" id="text_category" class="form-control" placeholder="Categoria" value="<?= $product->category ?>">
                ...
                <div class="col-lg-6 col-12">
                    <div class="mb-3">
                        ...
                        <input type="text" name="text_price" id="text_price" class="form-control" placeholder="Preço" value="<?= $product->price ?>">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12 mb-3">
                    ...
                    <input type="text" name="text_promotion" id="text_promotion" class="form-control" placeholder="Promoção" value="<?= $product->promotion ?>">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12 mb-3">
                    ...
                    <input type="text" name="text_stock_minimum_limit" id="text_stock_minimum_limit" class="form-control" placeholder="Limite mínimo de estoque" value="<?= $product->stock_min_limit ?>">
